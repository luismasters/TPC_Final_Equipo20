        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="formularioRegistro" style='<%# MostrarFormularioRegistro ? "display:block;" : "display:none;" %>'>
                    ...
                    <div><asp:Label ID="lblErrorRegistro" runat="server" CssClass="text-danger"></asp:Label></div>

                   <div> <asp:Button ID="BtnRegistrarse" runat="server" CssClass="btn btn-success" Text="Registrarse" OnClick="Btn_Registrarse_Click" /></div>
